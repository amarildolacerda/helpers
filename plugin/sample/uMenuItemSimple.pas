...
RegisterPlugin(TPluginMenuItemService.Create(TForm1, 'mnCadastro', 1,
  'Menu base de sample - test2'));

RegisterPlugin(TPluginControlService.Create(TForm1, 1, 0,
  'my control embbedded'));
